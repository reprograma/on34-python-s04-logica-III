def main():
    # Entrada
    # listas com strings que vou separar por espaço para identificar a palavra lei
    ...
    # Agrupando os textos em uma lista
    listas = [texto1, texto2, texto3, texto4]

   def sentenca(frase, palavra):
        # Transformar o texto em uma lista de palavras
        lista_de_palavras = frase.split(' ')
        # Contar quantas vezes a palavra aparece na lista
        qt = lista_de_palavras.count(palavra = 'lei')
        return qt
