...
print("Sistema de lei, confira qual texto é lei e qual texto não é ")
...
def textos():
    ...
    for texto in textos:
        contador_lei = texto.count("lei") 

        print(f"O texto:\n{texto}\ncontém a palavra 'lei' {contador_lei} vezes.\n")

        if contador_lei > contagem_de_texto:
            contagem_de_texto = contador_lei
            texto_escolhido = texto

    
    if texto_escolhido:
        
        print(f"Texto escolhido que aparece mais a palavra 'lei':\n{texto_escolhido}")
    print (f"tem o total {contagem_de_texto}")
