    ...
    for texto in lista_textos:
        ...
        for palavra in texto.split():
            if palavra.lower() == "lei":
                contador += 1
        quantidade_lei.append(contador)
    texto_escolhido = quantidade_lei.index(max(quantidade_lei))

    print("Olá, o texto sobre direito é este a seguir: ")
    print(lista_textos[texto_escolhido])
